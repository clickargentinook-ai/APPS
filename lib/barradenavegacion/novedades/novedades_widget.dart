                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                      ComunicacionesWidget.routeName);
                                },
                                text: 'VER',
                                options: FFButtonOptions(
                                  width: 70.0,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'COMUNICACIÓN DE LOS GREMIOS AERONÁUTICOS',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(GacetillasWidget.routeName);
                                },
                                text: 'VER',
                                options: FFButtonOptions(
                                  width: 70.0,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(DocumentosWidget.routeName);
                                },
                                text: 'VER',
                                options: FFButtonOptions(
                                  width: 70.0,
